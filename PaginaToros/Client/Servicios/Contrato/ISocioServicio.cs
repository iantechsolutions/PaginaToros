...
namespace PaginaToros.Client.Servicios.Contrato
{
    public interface ISocioServicio
    {
        ...
        Task<Respuesta<SocioPagedResponse>> SearchPaged(int skip, int take, string? searchText = null, string? sortBy = null, bool sortDescending = false);
        ...
        Task<Respuesta<SocioRepairResult>> RepairMissingScod();
    }
}
