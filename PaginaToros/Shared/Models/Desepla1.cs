...
public partial class Desepla1
{
    ...
    public int? Semprop { get; set; }

    public double? Cantor { get; set; }

    public double? Remmpr { get; set; }

    public int? Ctrlu { get; set; }

    public int? Ctrlm { get; set; }
    ...
    public double? IaSincro { get; set; }
